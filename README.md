...
官方 [`SKILL.md`](https://github.com/browser-use/browser-harness/blob/main/SKILL.md) 只有 ~120 行基础用法。本项目的 Skill 是在实际踩坑中**重写扩展到 367 行**的实战版本：
...
- 📖 [Skill 完整参考](skills/browser-harness/SKILL.md) — 所有 API、用法、陷阱
